...
public class LoginRequest extends GsonRequest<LoginResponse> {
    ...
    public LoginRequest(@NonNull String email, @NonNull String password, Response.Listener<LoginResponse> listener, Response.ErrorListener errorListener) {
        super(Method.POST, Conf.API_LOGIN, null, listener, errorListener);
        mEmail = email;
        mPassword = password;
    }
